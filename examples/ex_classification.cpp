...
int main(int argc, char *argv[]) {
    ...
    if (result.count("binary") > 0) {
        ...
        emg::RealTimeClassifier rt_classifier(sample_dim, Ts);
    ...
    if (result.count("multi") > 0) {
        ...
        emg::RealTimeMultiClassifier rt_classifier(num_classes, sample_dim, Ts);
		bool save_data = false;
    ...
    if (result.count("ensemble") > 0) {
        ...
        emg::EnsembleRTClassifier rt_classifier(sample_dim, Ts, ens_size);
